...
class ReadingTest(unittest.TestCase):
    ...
    def test_the_readme_of_this_project_names_addresses_to_check(self) -> None:
        """Or a survey that found nothing would report a clean run over nothing.

        The floor is what this readme carries with room underneath it rather
        than the count itself, which would have to be maintained beside the
        prose. What it catches is a readme that lost its references section.
        """
