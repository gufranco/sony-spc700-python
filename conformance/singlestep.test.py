...
class StateTest(unittest.TestCase):
    ...
    def test_the_stack_pointer_is_taken_from_the_test(self):
        cpu, _ = singlestep.machine_for(a_test()["initial"])

        self.assertEqual(cpu.sp, 0xEF)

    def test_the_status_register_is_taken_from_the_test(self):
        case = a_test()
    ...
    def test_the_machine_does_not_reset_itself_over_the_state(self):
        cpu, _ = singlestep.machine_for(a_test()["initial"])
