...
ELSEWHERE = ("referenceDoes", "otherImplementation")
"""Keys whose quotes are not in any pinned document.

referenceDoes quotes the access counts every emulator agrees on, and
otherImplementation quotes the source of the model this project is recorded as
disagreeing with. Neither is a printed page, so looking for them in a document
