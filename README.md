...
**256** opcodes, **256,000** conformance cases and **1,182,940** cycles compared, **0** failures, every cycle count checked against **Nintendo's own tables**, **798** tests, **100%** statement and branch coverage, no dependencies
